...
ZendMax.Form.validate = function(form, options)
{
    ...
    var settings = $.extend(
        {
            ...
            invalid: function(element, errorMessages) {
                var decorators = decorators = ZendMax.Forms[formId].elements[element.attr('name')].decorators,
                    i,
                    length,
                    iteration,
                    options;
    ...
    // ZendMax.Forms object is created within the form and injected in inlineScript helper and holds all the validation rules and parameters
